...
| One REST or gRPC request, MCP call, message, job, activity, or provider operation fails                            | Contain it at that boundary, record it once, return or retry safely, keep unrelated work serving                      |
